...
Usage examples:
  # Search .cyralis/compound (learning / trick / decision / explore docs share this dir)
  python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=learning --filter track=pitfall
  python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter "doc_type=decision|explore|learning"
  python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=trick --filter tags~=prisma
  ...
  python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=learning --filter track=knowledge --json

  # Sort by a frontmatter date field (works on any ISO-8601 date string, YAML date, or sortable value)
  python .cyralis/tools/search-yaml.py --dir .cyralis/library-docs --sort-by last_reviewed --order asc   # oldest first (stalest)
  python .cyralis/tools/search-yaml.py --dir .cyralis/compound --sort-by date --order desc              # newest first

  # Works on any yaml-frontmatter markdown directory
  python .cyralis/tools/search-yaml.py --dir docs/decisions --filter status=accepted
  python .cyralis/tools/search-yaml.py --dir content/posts --filter tags~=python --query "asyncio"
"""
