...
Usage examples:
  # Validate all .md files under cyralis/features
  python cyralis/tools/validate-yaml.py --dir cyralis/features

  # Validate a single file
  python cyralis/tools/validate-yaml.py --file cyralis/features/2026-04-11-auth/auth-design.md

  # Check that required fields exist in frontmatter
  python cyralis/tools/validate-yaml.py --dir cyralis/features --require doc_type --require status

  # JSON output for programmatic consumption
  python cyralis/tools/validate-yaml.py --dir docs/api --json

  # Validate the libdoc manifest
  python cyralis/tools/validate-yaml.py --file docs/api/manifest.yaml --yaml-only
"""
