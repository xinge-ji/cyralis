...
命中 caller patch、adapter patch、fallback patch、regex / keyword patch、local guard patch 时，先按 `.cyralis/reference/debugging-governance.md` 做 Patch-Shape Triage。
