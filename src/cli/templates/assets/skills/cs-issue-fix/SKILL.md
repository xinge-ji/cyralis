...
2. **上下文读全**：analysis 全文 + report 全文 + analysis 第 1 节定位的所有代码 + `.cyralis/attention.md` + 沉淀目录搜索：
...
4. 修复暴露了 README/docs、`CLAUDE.md` / `AGENTS.md` 或 `.cyralis/` 不一致 → "做一轮文档与知识库整理吗？（`cs-docs-neat`）"
