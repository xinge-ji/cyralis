...
python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=learning --filter track=pitfall --filter severity=high

# 按组件查相关学习点

python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=learning --filter component~={组件名}

# 归档后查重叠

python .cyralis/tools/search-yaml.py --dir .cyralis/compound --filter doc_type=learning --filter tags~={主要 tag} --json
```
